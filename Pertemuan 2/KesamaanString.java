...
/* Program diatas untuk menentukan apakah string tersebut memiliki teks yang sama
atau tidak, dengan membandingkan satu string dengan yang lainnya.
Jika kita lihat dari program diatas string tiga adalah "pemrogramanJava", jadi agar 
string nya sama kita dapat menambahkan string 1 ditambah string dua maka akan sama
dengan string tiga */